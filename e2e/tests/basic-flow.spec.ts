...
test("Create Connection", async ({ page }) => {
  ...
  await page.getByPlaceholder("Database Name").fill("Test Datasource");
  ...
  await page.getByText("Test Datasourcelocalhost").click();
  ...
  await expect(page.getByText("Test Datasource")).toBeVisible();
