...
class PostgresExecutorTest(
    ...
    override fun testSelectSimple() {
        executeQuery("SELECT 1 as col1, '2' as col2;") shouldBe RecordsQueryResult(
            ...
            executionRequestId = ExecutionRequestId("foo"),
        )
    }
