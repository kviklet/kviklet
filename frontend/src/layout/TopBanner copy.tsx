...
function TopBanner() {
  ...
  return (
    <div className="sticky h-12 top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 supports-backdrop-blur:bg-white/95 border-b border-slate-900/10 dark:border-b-slate-700">
            ...
            <div className="relative flex items-center ml-auto">
              ...
              <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
                ...
                <a href="https://github.com/kviklet/kviklet/" target="_blank" rel="noopener noreferrer">
                  <svg
                    viewBox="0 0 16 16"
                    className="w-5 h-5 mx-4 sm:ml-6"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                ...
                <a href="https://Kviklet.dev" target="_blank" rel="noopener noreferrer">about</a>
              </div>
            </div>
          </div>
        </div>
