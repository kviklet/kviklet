...
export default function ConnectionCard(props: {
  ...
  return (
    ...
    >
      <div className="group my-2 flex justify-between rounded-md border border-slate-200 bg-slate-50 px-2 py-1 align-middle shadow-md transition-colors dark:border dark:border-slate-700 dark:bg-slate-900 dark:shadow-none">
        <div>
